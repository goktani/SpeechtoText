...
# Türkçe ve İngilizce anahtar kelimeler listesi
...
keywords_fr = ["Aide", "Urgent",
                  "Sauvez-moi", "Danger", "Pompier",
                  "Ambulance", "Aidez-moi", "S'il vous plaît", "Blessé", "Perdu",]
        ...
        for response in responses:
            ...
            for keyword in keywords_tr + keywords_en:
                if keyword in transcript:
                    ...
                    if keyword == "çıkış" or keyword == "exit":
                        stream.closed = True
                        return
...
def main():
    ...
    config = speech.RecognitionConfig(
        ...
        alternative_language_codes=["tr-TR"],  # Alternatif dil Türkçe
    )
